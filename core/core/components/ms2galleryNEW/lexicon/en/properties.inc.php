...
$_lang['ms2gallery_prop_tpl'] = 'Fenom chunk for template the gallery.';
...
$_lang['ms2gallery_prop_includeThumbs'] = 'List of permissions preview separated by commas. For example, "small,medium".';
$_lang['ms2gallery_prop_includeOriginal'] = 'Adding to the sample an additional join with a link to the original image. Will be available in an array of resource as "alias.original", for example "small.original".';
...
$_lang['ms2gallery_prop_getPreviewProperties'] = 'When you enable this option, a placeholder with a preview turns into an array of all its properties. So you must use {$file.small.url} instead of {$file.small} and also can access {$file.small.properties}.';
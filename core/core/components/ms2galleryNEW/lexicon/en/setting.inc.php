...
$_lang['setting_ms2gallery_sync_ms2'] = 'Sync with MS2';
$_lang['setting_ms2gallery_sync_ms2_desc'] = 'Replace the gallery of miniShop2 products to ms2Gallery and enable two-way synchronization of files between them.';
$_lang['setting_ms2gallery_sync_tickets'] = 'Sync with Tickets';
$_lang['setting_ms2gallery_sync_tickets_desc'] = 'Allow to upload and edit Tickets files with ms2Gallery manager tab.';
...
$_lang['setting_ms2gallery_placeholders_thumbs_desc'] = 'Specify a comma-separated list of thumbs sizes, that you want to choose for placing in placeholders. For example "small,medium".';
...
//$_lang['setting_ms2gallery_thumbnail_size'] = 'Size of a preview by default';
//$_lang['setting_ms2gallery_thumbnail_size_desc'] = 'Size of default pre-generated thumbnail for manager. Of course, this size should exist in the settings of your media source that generates the previews. Otherwise you will receive logo of component instead of resource image.';

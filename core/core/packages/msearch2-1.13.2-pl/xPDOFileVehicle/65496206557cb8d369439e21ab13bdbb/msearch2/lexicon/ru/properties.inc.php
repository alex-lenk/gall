...
$_lang['mse2_prop_noPreciseMSFilters'] = 'Отключает выборку объектов товаров miniShop2 и вызов их методов для получения цены и веса. Ускоряет построение фильтров, но плагины для изменения цены и веса miniShop2 не работают.';
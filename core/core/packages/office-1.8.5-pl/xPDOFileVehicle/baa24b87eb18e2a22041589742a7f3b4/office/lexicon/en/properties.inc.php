...
$_lang['office_prop_allowRepeat'] = 'Allow to repeat orders.';
$_lang['office_prop_allowRemove'] = 'Allow to delete orders with the status "New".';
$_lang['office_prop_cartLink'] = 'Address of cart for checkout. You can specify any link or the resource id.';